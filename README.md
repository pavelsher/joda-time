...
[![build status]( 
http://localhost:8222/app/rest/builds/buildType:JodaTime_Build/statusIcon)](http://localhost:8222/viewLog.html?buildTypeId=JodaTime_Build&buildId=lastFinished) 
